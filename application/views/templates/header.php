...
<!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url()?>admin1/index">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url()?>admin1/index">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!-- <a class="collapse-item" href="<?php echo base_url()?>tipe">Tipe Mobil</a> -->
            <a class="collapse-item" href="<?php echo base_url()?>mobil">Mobil</a>
            <a class="collapse-item" href="<?php echo base_url()?>cm">Consumable Material</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseInput" class="collapse" aria-labelledby="headingInput" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url()?>mpp">12MPP</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTransaksi" class="collapse" aria-labelledby="headingTransaksi" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url()?>mrp">MRP</a>
            <a class="collapse-item" href="<?php echo base_url()?>ro">RO</a>
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url()?>chemical">
          <i class="fas fa-fw fa-recycle"></i> 
          <span>Chemical Waste</span></a>
      </li>
