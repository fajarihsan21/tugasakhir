...
class mrp extends CI_Controller {
    ...
    public function add()
    {
        ...
        $data['rows'] = $this->mrp_m->get()->result();
         ...
         $this->load->view('templates/headerppc' , $data);
         $this->load->view('mrp/mrp_form', $data);
         $this->load->view('templates/footer');
    }
    ...
    public function print(){
        ...
        $this->load->view('mrp/print_mrp', $data);

    }
}


// Create/locate a new mysql database to install MRP into
// Execute the file database/database.sql to create the tables needed
// unzip and upload MRP files to web server
